...
int main(){
	...
	cout<<"                           "<<endl;
	cout<<"  1: suma, resta, multiplicacion y division [1] \n  2: Determinar si un numero es par o impar [2] \n  3: Convertor de medidas [3] \n  4: palabra o un numero es palindromo [4] \n  5: Conversion de arabigo a romano [5] \n  6: Conversion de numeros enteros a letras [6] \n  7: Conversion de numero con decimal a letras [7] \n  8: Tabla de multiplicar [8] \n  9: Todas las tablas de multiplicar [9] \n  10: grafica la multiplicacion manual [10] \n  11: Conversion de decimales a binario [11] \n  12: Conversion de decimales a hexadecimal [12] \n  13: Crear figuras geometricas [13] \n  14: Mover un punto en la pantalla [14] \n  15: Cajero automatico [15] \n  16: Calcular hipotenusa [16]"<<endl;
	cout<<"                           "<<endl;
	cout<<endl<<"Numero de Opcion: ";
	cin>>opcion;
	cout<<"                           "<<endl;
...
{	
	cout<<"                           "<<endl;
	cout<<"Bienvenido al conversor de medidas, ingrese el sistema de medici?n que desea realizar"<<endl;
	int medida;
...
if((x<1)||(x>999)) cout<<"INGRESA UN NUMERO DEL 1 AL 999\n";
	...
	case 7: system("cls");cout<<"Conversion de n?meros enteros con decimal a letras: "<<endl;
{
		cout<<"                           "<<endl;
		int x,y;
	...
	case 13: system("cls");cout<<"Crear figuras geometricas basicas: "<<endl;
{
	...
	{
		cout<<endl;
		cout<<" ERROR ERROR ERROR ERORR ERROR ERROR ERROR ERORR ERROR ERROR ERROR ERORR"<<endl;
	system("pause");
	break;
	}
...
{
{
	...
	cout<<"                                          "<<endl;
	cout<<"Si desea regresar al menu ingrese 'r'\n";
